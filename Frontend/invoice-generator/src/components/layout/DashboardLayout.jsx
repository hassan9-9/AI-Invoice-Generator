        ...
        <div className="flex h-screen bg-gray-50">
            ...
            >
                ...
                <div className="absolute bottom-4 left-4 right-4">
                    <button
                        className="w-full flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-gray-700 hover:bg-gray-100 transition-colors"
                        onClick={logout}
                    >
            ...
            <div className={`flex-1 flex flex-col ${sidebarCollapsed ? 'md:ml-16' : 'md:ml-64'}`}>
                {/* Top navbar */}
                <header className="bg-white/80 backdrop-blur-sm border-b border-gray-200 h-16 flex items-center justify-between px-6">
